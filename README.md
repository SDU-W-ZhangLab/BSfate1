...
! [Computational_method](./image/Computational%20method.jpg)
...
! [Theoretical_model_analysis](./image/Theoretical%20model%20analysis.jpg)
...
! [results_simulation_A](./image/results_simulation_A.jpg)

! [other_DE_compare_A](./image/other_DE_compare_A.jpg)
...
```
! [hotplot_hESC](./image/hotplot_hESC.jpg)

! [switch_transient_TF_hESC](./image/switch_transient_TF_hESC.jpg)
...
BSfate_TFs=get_singleTF_BSfate_rank(SignificanceScore)
```
! [score_hESC](./image/score_hESC.jpg)

! [results_hESC](./image/results_hESC.jpg)
```
...
```
! [other_DE_compare_hESC](./image/other_DE_compare_hESC.jpg)

! [GO_results_hESC](./image/GO_results_hESC.jpg)
